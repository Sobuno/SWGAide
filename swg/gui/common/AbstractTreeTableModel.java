...
/**
 * Provides a base class for TreeTableModels; handles the list of listeners
 * <P>
...
public abstract class AbstractTreeTableModel implements TreeTableModel {
    ...
    /**
     * Creates an object of this class with {@code root} as root
     * 
     * @param root the root
     */
     ...
     * @param childIndices an array of child indices
    ...
    protected void fireTreeNodesChanged(Object source, Object[] path,
        ...
        for (int i = listeners.length - 2; i >= 0; i -= 2) {
            if (listeners[i] == TreeModelListener.class) {
                ...
                if (e == null)
                    e =
                            new TreeModelEvent(source, path, childIndices,
                                    children);
